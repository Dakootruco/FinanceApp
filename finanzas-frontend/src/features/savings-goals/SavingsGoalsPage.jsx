      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-900 dark:text-[#ffffff] tracking-tight flex items-center gap-2.5">
            <Target className="text-indigo-400 dark:text-[#FB00FF]" size={24} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="!bg-white dark:!bg-[#12131A] dark:bg-[#12131A] dark:!bg-[#12131A] dark:bg-[#12131A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded-3xl shadow-sm p-5 hover:shadow-md transition-shadow">
          <CardContent className="flex flex-col gap-1.5 p-0">
            <span className="text-[10px] text-slate-400 dark:text-[#94a3b8] font-bold uppercase tracking-wider">Total Ahorrado</span>
        ...
        <Card className="!bg-white dark:!bg-[#12131A] dark:bg-[#12131A] dark:!bg-[#12131A] dark:bg-[#12131A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded-3xl shadow-sm p-5 hover:shadow-md transition-shadow">
          <CardContent className="flex flex-col gap-1.5 p-0">
            <span className="text-[10px] text-slate-400 dark:text-[#94a3b8] font-bold uppercase tracking-wider">Meta Global</span>
            <span className="text-2xl font-black text-slate-800 dark:text-[#ffffff] tracking-tight">
        ...
        <Card className="!bg-white dark:!bg-[#12131A] dark:bg-[#12131A] dark:!bg-[#12131A] dark:bg-[#12131A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded-3xl shadow-sm p-5 hover:shadow-md transition-shadow">
          <CardContent className="flex flex-col gap-1.5 p-0">
            <span className="text-[10px] text-slate-400 dark:text-[#94a3b8] font-bold uppercase tracking-wider">Progreso Global</span>
            <div className="flex items-center gap-2">
              <span className="text-2xl font-black text-indigo-600 dark:text-[#FB00FF] tracking-tight">
                {globalProgress}%
              </span>
              <div className="flex-1 h-2 bg-slate-100 dark:bg-[#1C1D2A] rounded-full overflow-hidden">
                <div
                  className="h-full bg-indigo-500 dark:bg-[#FB00FF] rounded-full transition-all duration-700"
        ...
        <Card className="!bg-white dark:!bg-[#12131A] dark:bg-[#12131A] dark:!bg-[#12131A] dark:bg-[#12131A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded-3xl shadow-sm p-5 hover:shadow-md transition-shadow">
          <CardContent className="flex flex-col gap-1.5 p-0">
            <span className="text-[10px] text-slate-400 dark:text-[#94a3b8] font-bold uppercase tracking-wider">Faltante por Ahorrar</span>
            <span className="text-2xl font-black text-slate-800 dark:text-[#ffffff] tracking-tight">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        ...
        <div className="lg:col-span-2 flex flex-col gap-5">
          <h3 className="text-base font-extrabold text-slate-800 dark:text-[#ffffff] flex items-center gap-2">
            <PiggyBank size={18} className="text-indigo-400 dark:text-[#FB00FF]" />
          ...
          {savingsGoals.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-slate-500 dark:text-[#94a3b8] gap-3.5 bg-white dark:bg-[#12131A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded-3xl shadow-sm">
              ...
              <div className="text-center flex flex-col gap-0.5 mt-1">
                <p className="font-bold text-sm text-slate-800 dark:text-[#ffffff]">No hay planes de ahorro</p>
                <span className="text-xs text-slate-400 dark:text-[#94a3b8] font-semibold">Crea un plan para comenzar a ahorrar con propósito.</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {savingsGoals.map(goal => {
                ...
                return (
                  <Card key={goal.id} className="!bg-white dark:!bg-[#12131A] dark:bg-[#12131A] dark:!bg-[#12131A] dark:bg-[#12131A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded-3xl shadow-sm hover:shadow-md transition-all p-5 flex flex-col justify-between h-[260px]">
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-bold text-sm text-slate-800 dark:text-[#ffffff] truncate max-w-[160px]" title={goal.name}>
                              {goal.name}
                            </h4>
                            <span
                      ...
                      <div className="flex flex-col gap-2.5 bg-slate-50 dark:bg-[#1C1D2A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)]/50 rounded-2xl p-3">
                        <div className="grid grid-cols-2 gap-3 text-xs">
                          <div>
                            <span className="text-slate-400 dark:text-[#94a3b8] font-bold block text-[9px] uppercase tracking-wider">Ahorrado</span>
                            <span className="font-extrabold text-slate-700 dark:text-[#ffffff] mt-0.5 block">
                              {formatCurrency(currentAmount)}
                            </span>
                          </div>
                          <div className="text-right">
                            <span className="text-slate-400 dark:text-[#94a3b8] font-bold block text-[9px] uppercase tracking-wider">Meta</span>
                        ...
                        {/* Progress bar */}
                        <div className="relative w-full h-2 bg-slate-200 dark:bg-[#1C1D2A]/60 dark:bg-[#1C1D2A] rounded-full overflow-hidden">
                          <div
                    ...
                    <div className="flex items-center justify-between border-t border-slate-50 dark:border-[rgba(255,255,255,0.07)] pt-3.5 mt-2">
                      <div>
                        <span className="text-[9px] text-slate-400 dark:text-[#94a3b8] font-bold uppercase tracking-wider block">Restante</span>
                        <span className="font-black text-xs text-slate-700 dark:text-[#ffffff]">
        ...
        <div className="flex flex-col gap-5">
          <h3 className="text-base font-extrabold text-slate-800 dark:text-[#ffffff] flex items-center gap-2">
            <BarChart3 size={18} className="text-indigo-400 dark:text-[#FB00FF]" />
            Resumen de Progreso
          </h3>
          ...
          <Card className="!bg-white dark:!bg-[#12131A] dark:bg-[#12131A] dark:!bg-[#12131A] dark:bg-[#12131A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded-3xl shadow-sm p-6 flex flex-col h-full justify-between hover:shadow-md transition-shadow">
            <div className="flex flex-col gap-6">
              <span className="text-[10px] text-slate-400 dark:text-[#94a3b8] font-bold uppercase tracking-wider">Distribución de Planes</span>
                    ...
                    return (
                      <div key={goal.id} className="flex flex-col gap-2">
                        <div className="flex justify-between items-center text-xs">
                          ...
                          <div className="flex items-center gap-2">
                            <span className="font-extrabold text-slate-800 dark:text-[#ffffff]">{formatCurrency(currentAmount)}</span>
                            <span className="bg-slate-50 dark:bg-[#1C1D2A] border border-slate-100 dark:border-[rgba(255,255,255,0.07)] rounded px-1.5 py-0.5 text-[9px] font-bold text-slate-500 dark:text-[#94a3b8]">{percentage}%</span>
                          </div>
                        </div>
                        {/* Progress Bar */}
            ...
            {savingsGoals.length > 0 && (
              <>
                {/* Próximo a Completar */}
                {nearCompletion && (
                  <div className="border-t border-slate-50 dark:border-[rgba(255,255,255,0.07)] pt-5 mt-6 flex flex-col gap-1.5">
                    <span className="text-[10px] text-slate-400 dark:text-[#94a3b8] font-bold uppercase tracking-wider">Próximo a Completar</span>
                    <div className="flex items-center gap-2">
                      <div
                        className="w-2.5 h-2.5 rounded-full"
                        style={{ backgroundColor: nearCompletion.color_theme || '#6366f1' }}
                      />
                      <span className="text-xs font-bold text-slate-800 dark:text-[#ffffff]">{nearCompletion.name}</span>
                      <span
                ...
                <div className="border-t border-slate-50 dark:border-[rgba(255,255,255,0.07)] pt-5 mt-4 flex justify-between items-center text-xs text-slate-400 dark:text-[#94a3b8] font-semibold">
                  <span>Total de Planes:</span>
                  <span className="font-bold text-slate-800 dark:text-[#ffffff]">{savingsGoals.length}</span>
                </div>
              </>
            )}
          </Card>
